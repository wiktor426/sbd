...
struct qt_meta_stringdata_MainWindowProjectMember_t {
    QByteArrayData data[5];
    char stringdata[117];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_MainWindowProjectMember_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_MainWindowProjectMember_t qt_meta_stringdata_MainWindowProjectMember = {
    {
...
QT_MOC_LITERAL(4, 82, 33)
    ...
    "MainWindowProjectMember\0on_pushButton_2_clicked\0"
    "\0on_pushButtonProjectInfo_clicked\0"
...
const QMetaObject MainWindowProjectMember::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_MainWindowProjectMember.data,
      qt_meta_data_MainWindowProjectMember,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MainWindowProjectMember.stringdata))
